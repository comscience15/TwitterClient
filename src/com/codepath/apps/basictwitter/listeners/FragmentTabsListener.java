...
public class FragmentTabsListener<T extends Fragment> implements TabListener {
    ...
    public FragmentTabsListener(FragmentActivity activity, String tag, Class<T> clz) {
        mActivity = activity;
        mTag = tag;
        mClass = clz;
    ...
    public FragmentTabsListener(int fragmentContainerId, FragmentActivity activity, 
